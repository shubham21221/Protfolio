  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try again or email me directly at shubhamsonawane1011@gmail.com",
        variant: "destructive"
      });
    } finally {
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/shubham-sonawane-251b451a4/",
                  },
                  {
                    icon: Twitter,
                    label: "Twitter",
                  ...
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/shubham21221",
                  },
                  {
                    icon: Instagram,
                    label: "Instagram",
                    url: "https://www.instagram.com/shubham_sonawane_11/",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
