  ...
  return (
    ...
    >
      ...
      <div className="container max-w-5xl mx-auto text-center z-10">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
           {/* Crafting <span className="text-primary font-medium">user-friendly applications</span> and delivering <span className="text-secondary font-medium">scalable solutions</span> by combining my web development experience, internship projects, and passion for solving real-world problems. */}
           I am Shubham Sonawane, an M.Tech graduate in Computer Engineering with experience in web development and building scalable, user-friendly applications. Skilled in JavaScript, Python, and AI, I am passionate about software development and eager to apply my expertise to real-world projects.
          </motion.p>
      ...
      <motion.div 
        ...
        animate="float"
      >
        {['React', 'Node.js', 'TypeScript', 'C++', 'MongoDB', 'Java'].map((tech, i) => (
          <motion.div 
            key={tech}
      ...
      <motion.div 
        ...
        animate="float"
      >
        {['Express', 'Next.js', 'SQL', 'Tailwind', 'Anguler', 'Docker'].map((tech, i) => (
          <motion.div 
            key={tech}
            className="px-4 py-2 bg-background/80 backdrop-blur-sm border rounded-full text-sm shadow-sm"
            initial={{ x: 20, opacity: 0 }}
