...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/shubham-sonawane-251b451a4/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://www.instagram.com/shubham_sonawane_11/", label: "Instagram" },
    { icon: <Youtube size={18} />, href: "add YOutube link", label: "YouTube" },
    { icon: <Github size={18} />, href: "https://github.com/shubham21221", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "shubhamsonawane1011@gmail.com", href: "mailto:shubhamsonawane1011@gmail.com.com" },
    { icon: <Phone size={16} />, text: "+91 9172111770", href: "tel:+919172111770" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Shubham</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Crafting user-friendly applications and delivering scalable solutions by combining my web development experience, internship projects, and passion for solving real-world problems.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Shubham. All rights reserved.</p>
            </div>
